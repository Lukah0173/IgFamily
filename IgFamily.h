...
namespace IgFamily {
	...
	const string IGFAMILY_ROOT_DIR{ "filesystem_directory\\test.txt" };
	...
	const double PARAMETER_HOMOLOGY_WEIGHT{ 1.6 };
	const double PARAMETER_CONJUGATION_WEIGHT{ 1.2 };
	...
	const size_t TRAIN_SELECTED_GENE_FAMILY_PRECISION_CONDITION_2{ 10 };
