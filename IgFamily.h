...
namespace IgFamily {
	...
	const double PROTEIN_CONSTRUCT_PARAMETER_SCORE_THRESHOLD{ 1 };
	const double PROTEIN_CONSTRUCT_PARAMETER_DENSITY_CONJUGATED_THRESHOLD{ 0.15 };
	...
	const double PARAMETER_HOMOLOGY_WEIGHT{ 4.0 };
	const double PARAMETER_SCORE_CONJUGATION_WEIGHT{ 2.2 };
	const double PARAMETER_SCORE_MISMATCH_WEIGHT{ 0.8 };
	const double PARAMETER_IDENTITY_WEIGHT{ 1 };
	const double HOMOLOGY_SCORE_THRESHOLD{ 30 };
	...
	const double HOMOLOGY_QUERY_ALIGNMENT_COVERAGE_THRESHOLD{ 90 };
	...
	const double LOGISTIC_ITERATION_FACTOR{ DEFAULT_LOGISTIC_CONJUGATION_RANGE / double(1000000) };
}
