...
namespace IgFamily {
	...
	const double PARAMETER_HOMOLOGY_WEIGHT{ 1.2 };
	const double PARAMETER_CONJUGATION_WEIGHT{ 1.4 };
	double HOMOLOGY_SCORE_THRESHOLD{ 10 };
	const double HOMOLOGY_SCORE_THRESHOLD_2{ 30 };
	...
	double MULTINOMIAL_CONJUGATION_FACTOR_CONVERGE_1{ 0.001 };
	double MULTINOMIAL_CONJUGATION_FACTOR_LIMIT_2{ 50 };
	double MULTINOMIAL_CONJUGATION_FACTOR_CONVERGE_2{ 0.001 };
}
