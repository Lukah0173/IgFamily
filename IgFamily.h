...
namespace IgFamily {
	...
	const double PARAMETER_SCORE_MISMATCH_WEIGHT{ 0.30 };
	const double PARAMETER_SCORE_COVERAGE_DELTA_WEIGHT{ 0.50 };
	...
	const double PRIOR_DISTRIBUTION_WEIGHT{ 0.005 };

	const double DEFAULT_LOGISTIC_CONJUGATION_FACTOR{ 1 };
	double LOGISTIC_CONJUGATION_FACTOR{ DEFAULT_LOGISTIC_CONJUGATION_FACTOR };
	const double LOGISTIC_ITERATION_FACTOR{ 0.005 };
}
