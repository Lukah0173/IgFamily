...
namespace IgFamily {
	...
	const string IGFAMILY_ROOT_DIR{ "filesystem_directory\\Will_Murray-Brown-20160907.txt" };
	...
	const size_t SELECT_N_MANY_GENE_FAMILIES_INITIAL_TRAIN{ 200 };
