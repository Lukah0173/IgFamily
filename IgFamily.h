...
namespace IgFamily {
	...
	const double PARAMETER_HOMOLOGY_WEIGHT{ 3.2 };
	const double PARAMETER_SCORE_CONJUGATION_WEIGHT{ 1.8 };
	const double PARAMETER_SCORE_MISMATCH_WEIGHT{ 0.85 };
