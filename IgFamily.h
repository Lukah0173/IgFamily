...
namespace IgFamily {
	...
	const size_t SELECT_N_MANY_GENE_FAMILIES{ 5 };
	...
	const double PARAMETER_HOMOLOGY_WEIGHT{ 4.0 }; // >= 1
	const double PARAMETER_SCORE_CONJUGATION_WEIGHT{ 1.0 };
	const double PARAMETER_SCORE_MISMATCH_WEIGHT{ 0.80 };
	...
	const double DEFAULT_LOGISTIC_CONJUGATION_FACTOR{ 0.001 };
	double LOGISTIC_CONJUGATION_FACTOR{ DEFAULT_LOGISTIC_CONJUGATION_FACTOR };
	const double LOGISTIC_ITERATION_FACTOR{ 0.0001 };
}
