...
namespace IgFamily {
	...
	const size_t SELECT_N_MANY_GENE_FAMILIES{ 12 };
	...
	const double PARAMETER_HOMOLOGY_WEIGHT{ 3.0 }; // >= 1
	const double PARAMETER_SCORE_CONJUGATION_WEIGHT{ 1.4 };
	...
	const double LOGISTIC_ITERATION_FACTOR{ DEFAULT_LOGISTIC_CONJUGATION_RANGE / double(200000) };
