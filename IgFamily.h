...
namespace IgFamily {
	...
	const string IGFAMILY_ROOT_DIR{ "filesystem_directory\\Thilini-Mendis_20160514.txt" };
	...
	const size_t TRAIN_SELECTED_GENE_FAMILY_PRECISION_CONDITION{ 50 };
	const size_t TRAIN_SELECTED_GENE_FAMILY_PRECISION_CONDITION_2{ 15 };
